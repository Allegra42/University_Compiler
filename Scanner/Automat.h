 ...
 */
enum state {INIT, ERROR, EOF2, NUMBER, STRING, OPERATOR, EXCEPTION, LESSTHAN, COLON1, COLON2,
	COMMENT1,COMMENT2, STAR1, STAR2, COMM, SLASH, WHITESPACE, IDENTIFIER, NEWLINE,COMM_NEWLINE};
